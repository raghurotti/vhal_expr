...
void tcuStubImpl::setGateway(android::hardware::automotive::vehicle::V2_0::CAPIVehicleTCUServerGateway* gateway) {
    LOG_ALWAYS_FATAL_IF(gateway == nullptr, "TCU gateway argument is null");
    m_gateway_TCU = gateway;
}

android::hardware::automotive::vehicle::V2_0::CAPIVehicleTCUServerGateway& tcuStubImpl::getGateway() const {
    LOG_ALWAYS_FATAL_IF(m_gateway_TCU == nullptr, "TCU gateway not set");
    return *m_gateway_TCU;
}
...
getGateway().SendEvent_MsdTransmissionTime_TCU_To_IVI(_MsdTransmissionTime_TCU);
_reply();
}
...
getGateway().SendEvent_EcallState_TCU_To_IVI(_EcallState_TCU);
_reply();
}
...
getGateway().SendEvent_AcallState_TCU_To_IVI(_AcallState_TCU);
_reply();
}
...
getGateway().SendEvent_UserXcallFeedback_TCU_To_IVI(_UserXcallFeedback_TCU);
_reply();
}
...
getGateway().SendEvent_EcallDurationTimer_TCU_To_IVI(_EcallDurationTimer_TCU);
_reply();
}
...
getGateway().SendEvent_EcallTpsState_TCU_To_IVI(_EcallTpsState_TCU);
_reply();
}
...
getGateway().SendEvent_XcallStatus_TCU_To_IVI(_XcallStatus_TCU);
_reply();
}
...
getGateway().SendEvent_EcallWcbTimer_TCU_To_IVI(_EcallWcbTimer_TCU);
_reply();
}
...
getGateway().SendEvent_DmdMuteSual_TCU_To_IVI(_DmdMuteSual);
_reply();
}
...
getGateway().SendEvent_AppUrgMds_TCU_To_IVI(_AppUrgMds);
_reply();
}
...
getGateway().SendEvent_SignalVoyantDysfunction_TCU_To_IVI(_SignalVoyantDysfunction);
_reply();
}
...
getGateway().SendEvent_SignalVoyantEtat_TCU_To_IVI(_SignalVoyantEtat);
_reply();
}
...
getGateway().SendEvent_BoostrapRetryCount_TCU_To_IVI(_BoostrapRetryCount);
_reply();
}
...
getGateway().SendEvent_CloudConnectionStatus_CConnState_connectionGateID_TCU_To_IVI(_CloudConnectionStatus_CConnState_connectionGateID);
_reply();
}
...
getGateway().SendEvent_CloudConnectionStatus_CConnState_isConnected_TCU_To_IVI(_CloudConnectionStatus_CConnState_isConnected);
_reply();
}
...
getGateway().SendEvent_CloudConnectionStatus_CConnState_connType_TCU_To_IVI(_CloudConnectionStatus_CConnState_connType);
_reply();
}
...
getGateway().SendEvent_CloudConnectionStatus_CConnState_isRoaming_TCU_To_IVI(_CloudConnectionStatus_CConnState_isRoaming);
_reply();
}
...
getGateway().SendEvent_CloudConnectionStatus_CConnState_sigStrength_TCU_To_IVI(_CloudConnectionStatus_CConnState_sigStrength);
_reply();
}
...
getGateway().SendEvent_CloudConnectionStatus_CConnState_ipVersion_TCU_To_IVI(_CloudConnectionStatus_CConnState_ipVersion);
_reply();
}
...
getGateway().SendEvent_CellularNetworkType_TCU_To_IVI(_CellularNetworkType);
_reply();
}
...
getGateway().SendEvent_NetConnection_TCU_To_IVI(_NetConnection);
_reply();
}
...
getGateway().SendEvent_Cellsignal_TCU_To_IVI(_Cellsignal);
_reply();
}
...
getGateway().SendEvent_CloudConnectionStatus_CConnCtrl_reqDisable_TCU_To_IVI(_CloudConnectionStatus_CConnCtrl_reqDisable);
_reply();
}
...
getGateway().SendEvent_SLIRoadType_TCU_To_IVI(_SLIRoadType);
_reply();
}
...
getGateway().SendEvent_SLISpeedLimit_TCU_To_IVI(_SLISpeedLimit);
_reply();
}
...
getGateway().SendEvent_SLICountryCode_TCU_To_IVI(_SLICountryCode);
_reply();
}
...
void tcuStubImpl::sIdsRegisterApp(const std::shared_ptr<CommonAPI::ClientId> _client, std::string _appId, std::string _appName, sIdsRegisterAppReply_t _reply) {
    ...
    getGateway().Send_Register_App_TCU_To_IVI(_appId, _appName);
...
void tcuStubImpl::sIdsUnRegisterApp(const std::shared_ptr<CommonAPI::ClientId> _client, sIdsUnRegisterAppReply_t _reply) {
    ...
    getGateway().Send_UnRegister_App_TCU_To_IVI();
...
getGateway().SetFlashUnitId(FlashUnitId);
_reply();
}
...
getGateway().SetPackagePath(PackagePath);
_reply();
}
...
void tcuStubImpl::sIdsWriteSev(const std::shared_ptr<CommonAPI::ClientId> _client, ::VHAL::sIdsFramework_Types::sStSecurityEvent _sevEvent, ::VHAL::sIdsFramework_Types::sStLogIssuer _issuer1, ::VHAL::sIdsFramework_Types::sStEventSrc _issuer2, ::VHAL::sIdsFramework_Types::sStAction _issuer3, sIdsWriteSevReply_t _reply) {
    ...
    getGateway().Send_WriteSev_App_TCU_To_IVI(TcuSecEvent, TcuLogIssuer, TcuEventSrc, TcuAction);
...
void tcuStubImpl::sIdsExportSecurityEvents(const std::shared_ptr<CommonAPI::ClientId> _client, sIdsExportSecurityEventsReply_t _reply){
    ...
    getGateway().Send_ExportSecurityEvents_TCU_To_IVI();
...
void tcuStubImpl::sIdsSetVehiclePhase(const std::shared_ptr<CommonAPI::ClientId> _client, std::string _vehiclePhase, sIdsSetVehiclePhaseReply_t _reply){
    ...
    getGateway().Send_Vehicle_Phase_TCU_To_IVI(_vehiclePhase);
...
void tcuStubImpl::ReceiveFOTA_Check_for_Updates_Result(const std::shared_ptr<CommonAPI::ClientId> _client, std::string FOTA_Check_for_Updates_result, ReceiveFOTA_Check_for_Updates_ResultReply_t _reply){
    ...
    getGateway(). SendEvent_ReceiveFOTA_Check_for_Updates_Result(FOTA_Check_for_Updates_result);
    _reply();
}
void tcuStubImpl::ReceiveFOTA_Update_Available(const std::shared_ptr<CommonAPI::ClientId> _client, std::string FOTA_Update_Available, ReceiveFOTA_Update_AvailableReply_t _reply){
    ...
    getGateway(). SendEvent_ReceiveFOTA_Update_Available(FOTA_Update_Available);
    _reply();
}
void tcuStubImpl::ReceiveFOTA_Conditions_not_Met(const std::shared_ptr<CommonAPI::ClientId> _client, std::string FOTA_Conditions_not_Met, ReceiveFOTA_Conditions_not_MetReply_t _reply){
    ...
    getGateway(). SendEvent_ReceiveFOTA_Conditions_not_Met(FOTA_Conditions_not_Met);
    _reply();
}
void tcuStubImpl::ReceiveFOTA_Installation_Status(const std::shared_ptr<CommonAPI::ClientId> _client, std::string FOTA_Installation_Status, ReceiveFOTA_Installation_StatusReply_t _reply){
    ...
    getGateway(). SendEvent_ReceiveFOTA_Installation_Status(FOTA_Installation_Status);
    _reply();
}
void tcuStubImpl::ReceiveFOTAWhatsNew_Details_Response(const std::shared_ptr<CommonAPI::ClientId> _client, std::string FOTAWhatsNew_Details_Response, ReceiveFOTAWhatsNew_Details_ResponseReply_t _reply){
    ...
    getGateway(). SendEvent_ReceiveFOTAWhatsNew_Details_Response(FOTAWhatsNew_Details_Response);
    _reply();
}
void tcuStubImpl::ReceiveFOTAUpdate_History_Response(const std::shared_ptr<CommonAPI::ClientId> _client, std::string FOTAUpdate_History_Response, ReceiveFOTAUpdate_History_ResponseReply_t _reply){
    ...
    getGateway(). SendEvent_ReceiveFOTAUpdate_History_Response(FOTAUpdate_History_Response);
    _reply();
}
void tcuStubImpl::ReceiveFOTAPending_Updates_Response(const std::shared_ptr<CommonAPI::ClientId> _client, std::string FOTAPending_Updates_Response, ReceiveFOTAPending_Updates_ResponseReply_t _reply){
    ...
    getGateway(). SendEvent_ReceiveFOTAPending_Updates_Response(FOTAPending_Updates_Response);
    _reply();
}
void tcuStubImpl::ReceiveFOTA_Update_Finished(const std::shared_ptr<CommonAPI::ClientId> _client, std::string FOTA_Update_Finished, ReceiveFOTA_Update_FinishedReply_t _reply){
    ...
    getGateway(). SendEvent_ReceiveFOTA_Update_Finished(FOTA_Update_Finished);
    _reply();
} 
void tcuStubImpl::ReceiveFOTASchedule_Update_Response(const std::shared_ptr<CommonAPI::ClientId> _client, std::string FOTASchedule_Update_Response, ReceiveFOTASchedule_Update_ResponseReply_t _reply){
    ...
    getGateway(). SendEvent_ReceiveFOTASchedule_Update_Response(FOTASchedule_Update_Response);
    _reply();
} 
void tcuStubImpl::Receive_UIN_TCU(const std::shared_ptr<CommonAPI::ClientId> _client, std::string UIN_TCU_toHMI, Receive_UIN_TCUReply_t _reply){
    ...
    getGateway(). SendEvent_UIN_TCUToHMI(UIN_TCU_toHMI);
    _reply();
}
...
void tcuStubImpl::ReceiveTCU_Version_Number(const std::shared_ptr<CommonAPI::ClientId> _client, std::string TCU_version_number, ReceiveTCU_Version_NumberReply_t _reply){
    ...
    getGateway(). SendEvent_TCU_Version_Number_toHMI(TCU_version_number);
    _reply();
}
void tcuStubImpl::ReceiveAOSP_RBUA_Trigger(const std::shared_ptr<CommonAPI::ClientId> _client, std::string AOSP_RBUA_Trigger_Response, ReceiveAOSP_RBUA_TriggerReply_t _reply){
    ...
    getGateway(). SendEvent_ReceiveAOSP_RBUA_Trigger_Response(AOSP_RBUA_Trigger_Response);
    _reply();
}
void tcuStubImpl::FOTAHMI_Info_Result(const std::shared_ptr<CommonAPI::ClientId> _client, std::string FOTAHMI_InfoResult, FOTAHMI_Info_ResultReply_t _reply){
    ...
    getGateway(). SendEvent_FOTAHMI_Info_Result(FOTAHMI_InfoResult);
    _reply();
}
void tcuStubImpl::USBUpdate_Details(const std::shared_ptr<CommonAPI::ClientId> _client, std::string USBUpdate_details, USBUpdate_DetailsReply_t _reply){
    ...
    getGateway(). SendEvent_USBUpdate_Details(USBUpdate_details);
    _reply();
}
