...
/* namespace {
const char* kVendorTestSysPropKey = "debug.vendor.marelli.VENDOR_TEST_SYS_PROP";
}
 */
namespace vendor {
namespace marelli {
...
vhal_v2_0::StatusCode Simulator::setProperty(const vhal_v2_0::VehiclePropValue& value, bool updateStatus)
{
	...
	ALOGD("UpdateStatus %d", updateStatus);
...
/* vhal_v2_0::StatusCode Simulator::setVendorTestSysProp(const vhal_v2_0::VehiclePropValue& value, bool updateStatus)
{
    ...
    ALOGE("%s(): prop: %d, try to set READ property!", __func__, value.prop);
